 ...
 * information via the user interface about the product to be added to
...
public class AddProductPanel extends Panel {
    ...
    public AddProductPanel(Network network) {
        /*
        ...
        textPanel.addComponent(new Label("Name of the product:"));
        ...
        Button addButton = new Button("Add", () -> {
            ...
            if (!nameInputContent.isBlank()) {
                 ...
                 */
                try {
                    network.addProduct(new Product(nameInput.getText()));
