 ...
 * information via the user interface about the customer to be added to
...
public class AddCustomerPanel extends Panel {
    public AddCustomerPanel(Network network) {
        /*
        ...
        textPanel.addComponent(new Label("Name of the customer:"));
        ...
        Button addButton = new Button("Add", () -> {
            ...
            if (!nameInputContent.isBlank() && !zipcodeInput.getText().isBlank()) {
                 ...
                 */
                try {
                    network.addCustomer(new Customer(nameInput.getText(), Integer.valueOf(zipcodeInput.getText())));
                    nameInput.setText(""); // Setting the text inside a text box
                    zipcodeInput.setText("");
                    new MessageDialogBuilder()
                            .setText("Customer successfully added")
                            .setTitle("Success")
