 ...
 * information via the user interface about the delivery agent to be added to
 * the connected network.
 * It contains various other panels for layout reasons that segment the
 * interface into logical and aesthetic components.
 */
public class AddDeliveryAgentPanel extends Panel {
    public AddDeliveryAgentPanel(Network network) {
        /*
        ...
        textPanel.addComponent(new Label("Name of the delivery agent:"));
        ...
        Button addButton = new Button("Add", () -> {
            ...
            if (!nameInputContent.isBlank() && !zipcodeInput.getText().isBlank()) {
                 ...
                 */
                try {
                    network.addDeliveryAgent(
                            new DeliveryAgent(nameInput.getText(), Integer.valueOf(zipcodeInput.getText())));
                    nameInput.setText(""); // Setting the text inside a text box
                    zipcodeInput.setText("");
                    new MessageDialogBuilder()
                            .setText("Delivery agent added successfully.")
                            .setTitle("Success")
